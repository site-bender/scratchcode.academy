...
const description = collapseWhitespace(`
	Privacy policy for for ScratchCode, a haven for ScratchCoders in an AI world
...
export function getArticleData(version: string): Article {
	return {
		...
		about: "The Craft-Code.dev website privacy policy.",
		headline: "The Craft-Code.dev privacy policy",
		timeRequired: "PT2M6S",
		version,
		wordCount: 526,
	}
...
export function getOpenGraphData(): OpenGraphBasic {
	return {
		...
		description,
		title: "The ScratchCode site privacy policy",
	}
}
